...
if buying_or_selling == 'Sell':
    expected_ROI = st.number_input("How much ROI (in percentage) are you expecting?")
    original_price = st.number_input("How much did you buy the stock for (in dollars)?")
...
last_value_from_pred = round(last_value_from_pred, 2)
